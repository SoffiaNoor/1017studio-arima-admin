            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('residential.update',$residential->id)}}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="80"
                                            ...
                                            required>{{$residential->description}}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="80"
                                            ...
                                            placeholder="Here can be your description"
                                            required>{{$residential->description_eng}}</textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="80"
                                            ...
                                            required>{{$residential->list_type}}</textarea>
                                        @error('list_type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="/residential" class="btn btn-info text-white"><i

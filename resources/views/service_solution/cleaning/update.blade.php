            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('cleaning.update',$cleaning->id)}}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="80"
                                            ...
                                            required>{{$cleaning->description}}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="80"
                                            ...
                                            placeholder="Here can be your description"
                                            required>{{$cleaning->description_eng}}</textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="80"
                                            ...
                                            required>{{$cleaning->list_type}}</textarea>
                                        @error('list_type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="/cleaning" class="btn btn-info text-white"><i

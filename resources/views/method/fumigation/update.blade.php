            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('fumigation.update',$fumigation->id)}}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="80"
                                            ...
                                            required>{{$fumigation->description}}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="80"
                                            ...
                                            placeholder="Here can be your description"
                                            required>{{$fumigation->description_eng}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="/fumigation" class="btn btn-info text-white"><i
